...
# single player tictactoe game random function to generate the tictactoe, 
# if you lost to this perhaps you are not meant to play 
###################################
#game rules:
#
#
# how code progresses:
# tictactoe is a matrix where each cell is given a value based on its location as follows:
# 1,1|1,2|1,3         1*5|1*7|1*11           5| 7|11
# 2,1|2,2|2,3         2*5|2*7|2*11          10|14|22
# 3,1|3,2|3,3         3*5|3*7|3*11          15|21|33
# 
# 
#
#  
...
#       they say yes they are odd and you are even vice versa ( done)
#
